 ...
 var error=document.getElementById('error')
    ...
    if (data.weather[0].main=="Clouds") {
        body_img.src='C:\Users\lenovo\Desktop\Weather_App\cloud.png'
    }
     else if (data.weather[0].main=='Clear') {
        body_img.src='C:\Users\lenovo\Desktop\Weather_App\clear.jpeg'
    }
    else if (data.weather[0].main=='Rain') {
        body_img.src='C:\Users\lenovo\Desktop\Weather_App\rainy.jpeg'
    }
    else if (data.weather[0].main=='Drizzle') {
        body_img.src='C:\Users\lenovo\Desktop\Weather_App\Drizzle.jpeg'
    }
    else if (data.weather[0].main=='Mist') {
        body_img.src='C:\Users\lenovo\Desktop\Weather_App\Mist.png'
    }
    else if (data.weather[0].main=='Haze') {
        body_img.src='C:\Users\lenovo\Desktop\Weather_App\Haze.png'
    }
